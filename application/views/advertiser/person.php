            ...
            <table>
                <tr>
                    ...
                    <td class="border_bottom" align="center">
                        <p class="person_page_img">
                            <a href="./person.html" class="cur"><img src="../assets/images/icon1.png">&nbsp;个人</a>
                            <a href="./company.html"><img src="../assets/images/icon2.png">&nbsp;企业</a>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border_bottom">
                        ...
                        <p class="person_page_img1" @click="uploadImg('frontCard')"><img src="../assets/images/icon3.png"></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="border_bottom">
                        ...
                        <p class="person_page_img1" @click="uploadImg('backCard')"><img src="../assets/images/icon4.png"></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <p class="person_page_img1" @click="uploadImg('card')"><img src="../assets/images/icon5.png"></p>
                    </td>
                </tr>
            </table>
        </div>
