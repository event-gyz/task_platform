        ...
        <div class="main" style="margin-bottom: 0">
            ...
            <div class="login-style" style="padding-top: 0;">
                <div class="input-box" style="margin-bottom: 0px">
                    <table>
                        <tr>
                            <th align="left" class="border_bottom" width="70px;">客户名称</th>
                            <td class="border_bottom" align="right">爱奇艺</td>
                        </tr>
                        <tr>
                            <th align="left" class="border_bottom" >时间</th>
                            <td class="border_bottom" align="right">2015年4月</td>
                        </tr>
                        <tr>
                            <th align="left">推广内容</th>
                            <td align="right">综艺节目《奇葩说》进北大的宣传</td>
                        </tr>
                    </table>
                </div>
                <p class="case_info">
                    <img src="../assets/images/logo/3/1.png">
                </p>
            </div>
