    ...
    <body>
        <div class="main">
            <div class="statu_style">
                ...
                <!--被冻结-->
                <div class="statu_box">
                    <p class="icon-box"><img src="../assets/images/status/dj.png"></p>
                    <h2>被冻结</h2>
                ...
                <!--未上传资质信息-->
                <div class="statu_box">
                    <p class="icon-box"><img src="../assets/images/status/wsc.png"></p>
                    <h2>未上传资质信息</h2>
                ...
                <!--广告主保存成功-->
                <div class="statu_box">
                    <p class="icon-box"><img src="../assets/images/status/bc.png"></p>
                    <h2>保存成功</h2>
