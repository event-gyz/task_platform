...
<html>
    ...
    <body>
                        ...
                        <tr>
                            ...
                            <td class="border_bottom">
                                ...
                                <ul class="generalize_up_button">
                                    <li class="img" @click="uploadImg"><img src="../assets/images/Bitmap.png"></li>
                ...
                <div class="input-box" style="margin-bottom:0px">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="border_bottom" align="center">
                                <p class="index_advert_icon">
                                    <span @click="numAsk = 0" :class="{cur:!numAsk}"><img v-if="!numAsk" src="../assets/images/icon1.png"><img v-else src="../assets/images/icon2.png">&nbsp;无要求</span>
                                    <span @click="numAsk = 1" :class="{cur:numAsk}"><img v-if="!numAsk" src="../assets/images/icon2.png"><img v-else src="../assets/images/icon1.png">&nbsp;自定义要求</span>
                                </p>
                            </td>
                        </tr>
                                ...
                                <div class="bg">
                                    <table>
                                        <tr>
                                            ...
                                            <td class="border_bottom">
                                                <p class="index_advert_icon">
                                                    <span @click="setSex(0)" style="width:32%" :class="{cur:sex==0}"><img v-show="sex==0" src="../assets/images/icon1.png"><img v-show="sex!=0" src="../assets/images/icon2.png">&nbsp;不限</span>
                                                    <span @click="setSex(1)" style="width:32%" :class="{cur:sex==1}"><img v-show="sex==1" src="../assets/images/icon1.png"><img v-show="sex!=1" src="../assets/images/icon2.png">&nbsp;男</span>
                                                    <span @click="setSex(2)" style="width:32%" :class="{cur:sex==2}"><img v-show="sex==2" src="../assets/images/icon1.png"><img v-show="sex!=2" src="../assets/images/icon2.png">&nbsp;女</span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="border_bottom">
                                <p class="index_advert_icon">
                                    <span :class="{cur:platform.indexOf('微信')!=-1}" @click="setPlatform('微信')"><img v-show="platform.indexOf('微信')!=-1" src="../assets/images/icon7.png"><img v-show="platform.indexOf('微信')==-1" src="../assets/images/icon8.png">&nbsp;微信</span>
                                    <span :class="{cur:platform.indexOf('微博')!=-1}" @click="setPlatform('微博')"><img v-show="platform.indexOf('微博')!=-1" src="../assets/images/icon7.png"><img v-show="platform.indexOf('微博')==-1" src="../assets/images/icon8.png">&nbsp;微博</span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="index_advert_icon">
                                    <span :class="{cur:endStandard.indexOf('图片')!=-1}" @click="setEndStandard('图片')"><img v-show="endStandard.indexOf('图片')!=-1" src="../assets/images/icon7.png"><img v-show="endStandard.indexOf('图片')==-1" src="../assets/images/icon8.png">&nbsp;图片</span>
                                    <span :class="{cur:endStandard.indexOf('链接')!=-1}" @click="setEndStandard('链接')"><img v-show="endStandard.indexOf('链接')!=-1" src="../assets/images/icon7.png"><img v-show="endStandard.indexOf('链接')==-1" src="../assets/images/icon8.png">&nbsp;链接</span>
                                </p>
                            </td>
                        </tr>
                    </table>
        ...
        <script type="text/javascript" src="../assets/js/third/moment.min.js"></script>
        <script type="text/javascript" src="../assets/js/third/jquery-weui.js"></script>
        <script type="text/javascript" src="../assets/js/generalize.js"></script>
    </body>
</html>