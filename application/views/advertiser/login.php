    ...
    <body>
        <div class="main" id="app">
            ...
            <div>
                ...
                <p class="login-text">
                    <a class="left" href="/advertiser/login/register">立即注册</a>
                    <a class="right" href="/advertiser/login/forget">忘记密码</a>
                </p>
            </div>
        </div>
        ...
        <script type="text/javascript" src="/js/loginAdvert.js"></script>
    </body>
</html>